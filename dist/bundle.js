...
var DotGraph = /** @class */ (function (_super) {
    ...
    function DotGraph(target) {
        ...
        _this.width = 400;
        _this.height = 500;
        _this.xScale = d3_scale_1.scaleLinear().domain([0, 40]).range([0, 400]);
        _this.yScale = d3_scale_1.scaleLinear().domain([0, 50]).range([500, 0]);
        return _this;
    }
