...
var mainSelect = mainDiv.append('select');
...
options.forEach(function (option) {
  mainSelect.append('option').attr('value', option.value).text(option.text);

  var mainOptions = d3.selectAll('option').on('change', function () {
